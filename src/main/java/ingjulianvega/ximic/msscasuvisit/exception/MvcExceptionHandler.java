...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(VisitParameters visitParameters) {
    ...
    public ResponseEntity<ApiError> validationErrorHandler(VisitException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(visitParameters.getApi())
