...
import ingjulianvega.ximic.msscasuvisit.configuration.VisitParameters;
...
public class ErrorMessageResolver {
    ...
    private final VisitParameters visitParameters;
    ...
    public ApiError resolveException(final String key) {
        ...
        return ApiError.builder().code(visitParameters.getPrefix() + errorArr[0]).description(errorArr[1]).build();
    }

    private ApiError getApiGenericError() {
        final String message = "UNKNOWN ERROR";
        return ApiError.builder()
                .code(visitParameters.getPrefix() + "500:199")
                .description(message)
                .build();
    }
}
